# @file Visual.py
#
# @brief Uses opencv to draw to results
...
class Visual(BeeProcess):
    """! Separate process to visualize the programs results.
         It uses in-queue to receive the current image and the tracking results
    """
